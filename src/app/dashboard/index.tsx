    ...
    <div className={styles.mainContainer}>
      ...
      <div className={styles.gridContainer}>
            ...
            <div className={styles.impactCards}>
              <div className={styles.impactCard}>
                <div className={styles.impactLabel}>
                  <Recycle size={16} />
                  <span>Terdaur Ulang</span>
                </div>
                <p className={styles.impactValue}>
                  12.5 <span className={styles.impactValueSmall}>kg</span>
                </p>
              </div>
              <div className={styles.impactCard}>
                <div className={styles.impactLabel}>
                ...
                <p className={styles.impactValue}>
                  2.1 <span className={styles.impactValueSmall}>kg</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={styles.rightColumn}>
          ...
          {/* Sumber Poin */}
          <div className={styles.pointsSourceCard}>
            <h3 className={styles.pointsSourceTitle}>Sumber Poin (Total)</h3>
            <div className={styles.pointsSourceList}>
              <div className={styles.pointsSourceItem}>
                <div className={styles.pointsSourceHeader}>
                  <span className={styles.pointsSourceLabel}>
                    Botol Plastik
                  </span>
                  <span className={styles.pointsSourceAmount}>300 Pts</span>
                </div>
                <div className={styles.pointsProgressBar}>
                  <div
                    className={`${styles.pointsProgressFill} ${styles.plastic}`}
                    style={{ width: "75%" }}
                  ></div>
                </div>
              </div>
              <div className={styles.pointsSourceItem}>
                <div className={styles.pointsSourceHeader}>
                  <span className={styles.pointsSourceLabel}>Botol Kaleng</span>
                  <span className={styles.pointsSourceAmount}>100 Pts</span>
                </div>
                <div className={styles.pointsProgressBar}>
                  <div
                    className={`${styles.pointsProgressFill} ${styles.metal}`}
                    style={{ width: "25%" }}
                  ></div>
                </div>
              </div>
          ...
          <div className={styles.ctaCard}>
            ...
            <button className={styles.ctaButton}>Lihat Katalog Hadiah</button>
          </div>
        </div>
      </div>
    </div>
